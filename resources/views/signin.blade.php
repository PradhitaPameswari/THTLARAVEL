...
<body>
    <div class="container">
        <div class="illustration">
            <img src="{{ asset('images/signin.png') }}" alt="Sign In Illustration" style="width: 100%; height: 100%; object-fit: cover;">
        </div>
        <div class="form-container">
            ...
            @endif
            <p style="text-align:center; margin: 15px 0px;">-- Or Sign In with --</p>
